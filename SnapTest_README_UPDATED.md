...
| 수동생성 | 자동생성(AI-Gemini(Flash 2.0) |
|--------------|-----------|
| ![실행 중](demo-images/2.1테스트케이스등록(수동).png) | ![결과](demo-images/2.2테스트케이스등록(자동).png) |

---

### 3️⃣ 리포트 및 분석

![리포트 상세](demo-images/4.리포트상세(feat.재실행).png)

---

### 4️⃣ 테스트 케이스 관리

![테스트 케이스 목록](demo-images/snap_case_list.png)  
👉 케이스 검색, 편집, 삭제, 복사 등 기능 제공
